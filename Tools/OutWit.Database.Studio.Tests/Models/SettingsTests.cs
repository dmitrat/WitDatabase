...
public class SettingsTests
{
    ...
    [Test]
    public void DefaultCountRowsAutomaticallyIsTrueTest()
    {
        // Arrange & Act
        var settings = new Settings();

        // Assert
        Assert.That(settings.CountRowsAutomatically, Is.True);
    }
    ...
    public void ClonePreservesAllPropertiesTest()
    {
        ...
        Assert.That(clone.CountRowsAutomatically, Is.False);

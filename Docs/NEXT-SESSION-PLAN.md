...
>
> **63 `[Ignore(…)]` attributes plus 14 `[TestCase(… Ignore =)]` — 77 suppressed entries**, and **2**
> `[Explicit]`, counted 2026-07-30 after the second half's first PR closed three row-lock markers (it was

...
```xml
<PackageReference Include="OutWit.Database.Core.IndexedDb" Version="14.0.1" />
```
...
If you use OutWit.Database.Core.IndexedDb in a product, a mention is appreciated (but not required), for example:

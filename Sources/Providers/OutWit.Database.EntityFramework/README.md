...
Licensed under the [Apache License, Version 2.0](https://www.apache.org/licenses/LICENSE-2.0). See `LICENSE`.

## Attribution (optional)

If you use OutWit.Database.EntityFramework in a product, a mention is appreciated (but not required), for example:

...
```xml
<PackageReference Include="OutWit.Database.Parser" Version="14.0.1" />
```
...
If you use OutWit.Database.Parser in a product, a mention is appreciated (but not required), for example:
